...
import {selectAvailableLanguages} from '../store/slices/languageSlice.js';

/**
 * Language Selector - Component for changing application language
 */
export class LanguageSelector extends ReduxMixin(LitElement) {
  constructor() {
    super();
  }
  ...
  _toggleLanguage() {
    ...
    const availableLanguages = selectAvailableLanguages(this.getState());
